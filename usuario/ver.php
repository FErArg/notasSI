...
echo "<table border=\"1\">\n";
echo "<th> ID </th><th> Titulo </a></th><th> Fecha </th><th> Ver </th><th> Editar </th><th> Eliminar </th>";
foreach($resultado as $value){
		echo "<tr>";
		echo "<td>".$value['id']."</td><td><a href=\"".$value['enlace']."\">".$value['titulo']."</a></td><td>".$value['fecha']."</td>";
